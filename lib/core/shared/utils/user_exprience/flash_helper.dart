...
import 'package:project_boilerplate/app/routing/app_routes_fun.dart';
...
class FlashHelper {
              ...
              Expanded(
                child: Text(
                  ...
                  style: context.regularText
                      .copyWith(fontSize: 16, color: context.primaryColorLight),
                ),
              ),
              Container(
                height: 24.h,
  ...
  static String _getToastIcon(MessageTypeTost msgType) {
    return 'assets/images/sa_logo.png';
